...
class MapReduceNodesSpec extends AnyFlatSpec with Matchers {

  "Map" should "generate a non-empty file at the specified output path" in {
    
//    val outputFilePath = "C:\\Users\\kirta\\Desktop\\CS441\\NetGameSim\\src\\main\\resources\\output_nodes\\part-00000"
    val outputFilePath = "src/main/resources/output_nodes/part-00000"
