...
lazy val NetModelGenerator = (project in file("NetModelGenerator"))
  .settings(
    ...
    libraryDependencies ++= commonDependencies ++ Seq(
      ...
      "org.apache.hadoop" % "hadoop-mapreduce-client-jobclient" % "3.2.4",
      "ch.qos.logback" % "logback-classic" % "1.2.6",
      "org.yaml" % "snakeyaml" % "1.29",
      "log4j" % "log4j" % "1.2.17",
      "com.fasterxml.jackson.dataformat" % "jackson-dataformat-yaml" % "2.13.1",
      "software.amazon.awssdk" % "s3" % "2.17.92",
    )
...
libraryDependencies += "org.apache.hadoop" % "hadoop-mapreduce-client-core" % "3.2.4"
libraryDependencies += "org.apache.hadoop" % "hadoop-mapreduce-client-jobclient" % "3.2.4"
